...
using Aspose.ThreeD.Cloud.Live.Demos.UI.Controllers;
...
namespace Aspose.ThreeD.Cloud.Live.Demos.UI.Models
{
	public class LandingPageModel
	{
		...
		public AsposeThreeDCloudContext AsposeThreeDCloudContext
		{
			get
			{
				if (_atcContext == null) _atcContext = new AsposeThreeDCloudContext(HttpContext.Current);
				return _atcContext;
			}
		}
		...
		public string UIBasePath => Configuration.AsposeThreeDCloudLiveDemosPath;
